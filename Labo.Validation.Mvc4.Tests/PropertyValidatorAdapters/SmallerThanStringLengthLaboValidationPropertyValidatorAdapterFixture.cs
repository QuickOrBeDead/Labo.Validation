namespace Labo.Validation.Mvc4.Tests.PropertyValidatorAdapters
{
    ...
    [TestFixture]
    public class SmallerThanStringLengthLaboValidationPropertyValidatorAdapterFixture : LaboPropertyValidatorAdapterFixtureBase
    {
        ...
        public override void ValidateClientValidationRules(LaboPropertyValidator laboPropertyValidator, IList<ModelClientValidationRule> modelClientValidationRules)
        {
            ...
            Assert.AreEqual("'Test' must be smaller than 150 length.", modelClientValidationRules[0].ErrorMessage);
        ...
        {
            return new EntityPropertyValidator(new LengthValidator(0, 150));
        }
    }
}