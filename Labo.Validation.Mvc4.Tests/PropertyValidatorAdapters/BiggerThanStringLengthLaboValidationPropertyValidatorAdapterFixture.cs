namespace Labo.Validation.Mvc4.Tests.PropertyValidatorAdapters
{
    ...
    [TestFixture]
    public class BiggerThanStringLengthLaboValidationPropertyValidatorAdapterFixture : LaboPropertyValidatorAdapterFixtureBase
    {
        ...
        {
            return new EntityPropertyValidator(new LengthValidator(5));
        }
    }
}