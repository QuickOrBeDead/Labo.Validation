namespace Labo.Validation.Validators
{
    ...
    public sealed class LessThanValidator : ValidatorBase
    {
        ...
        public override ValidatorType ValidatorType
        {
            get
            {
                return ValidatorType.LessThanValidator;
            }
        }
        ...
        public override string GetValidationMessage(string valueName, params string[] arguments)
        {
            ...
            string validationMessage = messageBuilder.SetMessageResourceName(Constants.ValidationMessageResourceNames.LESS_THAN_VALIDATION_MESSAGE)
