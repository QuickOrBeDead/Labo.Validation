namespace Labo.Validation.Validators
{
    ...
    public sealed class GreaterThanValidator : ValidatorBase
    {
        ...
        public override ValidatorType ValidatorType
        {
            get
            {
                return ValidatorType.GreaterThanValidator;
            }
        }
        ...
        public override string GetValidationMessage(string valueName, params string[] arguments)
        {
            ...
            string validationMessage = messageBuilder.SetMessageResourceName(Constants.ValidationMessageResourceNames.GREATER_THAN_VALIDATION_MESSAGE)
